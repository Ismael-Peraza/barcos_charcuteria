    ...
    <head>
        ...
        <div class="anchito">
            ...
            <form name="formaddpago" action="procesar/insertarpago.php" method="POST">
                <fieldset>
                    <legend>Registrar Nuevo Pago:</legend><br>
                        <?php
                            echo "<input type='hidden' name='cliente' value='".$_GET['verid']."'/>";
                            echo "Cliente: <input class='formulario2' type='text' name='nombrecli' value='".$_GET['vercli']."' disabled readonly/><br>";
                            echo "<input type='hidden' name='nombrecli' value='".$_GET['vercli']."'/>";
                        ?>
                        &nbsp&nbsp&nbsp&nbsp&nbsp;
