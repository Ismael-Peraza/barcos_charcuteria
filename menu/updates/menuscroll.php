            ...
            <div class="ancho">
                ...
                <nav>
                    ...
                    <?php
                        ...
                        {echo "
                            <li><a href='backhome.html'>Inicio</a></li>
                            ...
                            <li><a>Modificar</a>
                                <ul>                                
                                    <li><a href='../ver/ventaall.php?destination=../updates/updateventa'>Venta</a></li>
                                    <li><a href='../ver/pagoall.php?destination=../updates/updatepago'>Pago</a></li>
                                    ...
                                    <ul>";                                
                                                ...
                                                {
                                                    echo "<li><a href='updateusuario.php?verusu=".$listau2['usuario']."'>".$listau2['usuario']."</a></li>";
                                                }
                                    echo    
                                    "</ul>
                                    </li>
                        ...
                        {echo "
                            ...
                            <li><a href='../seecliente.php?destination=addventa'>Venta</a></li>
                            <li><a href='../seepago.php'>Pagos</a></li>
                            <li><a href='../seecliente.php?destination=clientex'>Clientes</a></li>
                            ";
                        }
                         echo "
