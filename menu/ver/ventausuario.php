            ...
            <div class="lista1">
                ...
                <input type="button" value="Todas los Pagos" onClick="window.location.href = 'pagousuario.php'">
                    ...
                    <?php
                        ...
                        echo "<br><br><h1>Ventas Totales de ".$verusu."</h1><br>";
                            ...
                            */
                            foreach ($lista as $lista2)
                            {
                                ...
                                //para que funcione
                                    ...
                                    echo "<tr>"
                                            . "<th>"
                                                . "<a href='".$destino.".php?idven=".$lista2['idventa']."&idcli=".$lista2['nombre']."&destination=".$destination."&verusu=".$verusu."'>".$lista2['DATE_FORMAT(ven.fecha, "%d-%m-%Y")']."</a>"
                                            . "</th>"
                                            . "<td>".$lista2['precio']."</td>"
                                            . "<td>".$lista2['nombre']."</td>"
                                            . "<td>".$mensaje."</td>"
