    ...
    <head>
        ...
        <div class="anchito2">
            ...
            <div class="lista1">
                ...
                <!--
                <form name="formaddcom" action="../procesar/insertarcomentario.php" method="POST">
                    
                    <textarea class="formulario2" rows="5" cols="60" name="coment" <?php echo "value='".$coment."'" ?> placeholder="<?php echo $coment ?>" ></textarea>
                    
                    <?php
                    /*
                        echo "<input type='hidden' name='id' value='".$verid."'/>";
                        echo "<input type='hidden' name='cli' value='".$vercli."'/>";
                        echo "Usuario: ".$usunota."&nbsp&nbsp&nbsp&nbsp;Fecha: ".$fechanota;
                    ...
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;
                    &nbsp&nbsp&nbsp&nbsp&nbsp;
                    <button class="formulario2" type="submit" class="boton-2" name="registrar">Guardar Nota</button>
                </form>
                -->
                </div>
                <div class="lista1">
